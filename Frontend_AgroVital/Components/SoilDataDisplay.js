...
const BluetoothConnection = ({ onConnect, isConnected }) => (
  <TouchableOpacity
    style={{
      marginHorizontal: 16,
      marginTop: 8,
      marginBottom: 12,
      backgroundColor: isConnected ? "#4CAF50" : "#0B6E0B",
      paddingVertical: 14,
      borderRadius: 12,
      alignItems: "center",
    }}
    onPress={() => onConnect(!isConnected, isConnected ? null : "Demo Sensor")}
  >
    <Text style={{ color: "#fff", fontSize: 16, fontWeight: "600" }}>
      {isConnected ? "Disconnect Sensor" : "Connect Demo Sensor"}
    </Text>
  </TouchableOpacity>
);
...
const SoilDataDisplay = () => {
  ...
  const user = { email: "nnpstudio9@gmail.com" };
